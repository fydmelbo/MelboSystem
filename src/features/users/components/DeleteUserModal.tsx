...
export default function DeleteUserModal({ userEmail, onConfirm, onClose }: DeleteUserModalProps) {
    ...
    >
      <div className="py-2 space-y-4">
        <p className="text-gray-600">
          ¿Estás seguro que deseas eliminar al usuario <span className="font-semibold text-gray-900">{userEmail}</span>?
        </p>
        ...
        <div className="mt-4 p-3 bg-red-50 border border-red-100 rounded-lg flex gap-3">
          ...
          <p className="text-sm text-red-800">
            Esta acción enviará al usuario al Histórico. El usuario perderá inmediatamente el acceso al sistema.
          </p>
        </div>
      </div>
    </BaseModal>
